...
public class DependencyHelper {
   ...
   * 
   * @param dependencyGraph configuration object
   ...
   */
  public MavenProject findMavenProject(DependencyGraph dependencyGraph)
      throws MojoExecutionException {
    Artifact artifact = getArtifactByRootArtifact(dependencyGraph);
    return getProjectByArtifact(artifact);
  }

  private Artifact getArtifactByRootArtifact(DependencyGraph graphConfig)
      throws MojoExecutionException {
